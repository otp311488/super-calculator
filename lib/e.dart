...
class _powerConverterState extends State<powerConverter> {
  ...
  Map<String, double> conversionFactors = {
    'Kilowatts': 0.00134102,
    'Watts': 1.34102,
    'Horsepower (US)': 0.00181818,
  ...
  Widget buildSpeedConverterCard({
      ...
      child: Column(
        ...
        children: [
          ...
          if (isExpanded)
            Column(
              children: [
                buildListTile('Kilowatts'),
                buildListTile('Watts'),
                buildListTile('Horsepower (US)'),
                buildListTile('Foot-Pounds/Minute'),
                buildListTile('BTUs/Minute'),
              ],
            ),
          Padding(
            padding: const EdgeInsets.all(16.0),
